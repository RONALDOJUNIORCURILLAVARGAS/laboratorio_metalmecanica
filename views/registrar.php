...
<head>
    ...
    <link href="../src/styles/registro.css" rel="stylesheet" type="text/css"/>
  ...
  <div id="container_left">
    ...
    <div id="registros">
        <div id="form_usuario">
                ...
                <input type="text" class="form-control" name="nombre" id="floatingInput" placeholder="example@unfv.edu.pe">
                <label for="floatingInput">Nombres</label>
                </div>
                <div class="form-floating mb-3">
                <input type="text" class="form-control" name="apellido" id="floatingInput" placeholder="example@unfv.edu.pe">
                ...
                <input type="password" class="form-control" name="clave_2" id="floatingPassword" placeholder="Password">
        ...
        <div id="botones">
            ...
            <div id="b_botones" >
                ...
                <div id="caja_btn_registrar">
                    <button id="btn_registrar" onclick="acceder();">
                       ACCEDER
                    </button>
                </div>
